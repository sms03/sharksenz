  ...
  const plans: PricingPlan[] = [
    {
      ...
      features: [
        { text: "Limited Learning Content", included: true },
        { text: "One Analytics Tool", included: true, tooltip: "Access to one analytics tool from our analytics dashboard" },
        { text: "Weekly Newsletter", included: true },
        { text: "Full Content Library", included: false },
        { text: "Complete Analytics Suite", included: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Full Analytics  Dashboard Access", included: true, tooltip: "Access to all analytics tools and features" },
        { text: "Customer Support", included: true },
        { text: "Discord Access", included: true },
        { text: "Exclusive Templates", included: false },
        { text: "Advanced Pitch Simulator", included: false },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Exclusive Templates", included: true, tooltip: "Access to premium templates and resources" },
        { text: "Advanced Pitch Simulator", included: true, tooltip: "Enhanced pitch simulator with AI feedback" },
        { text: "White-label Reports", included: true, tooltip: "Customizable reports with your branding" },
        { text: "Custom Branding", included: true, tooltip: "Customize the platform with your company branding" },
        { text: "API Access", included: true, tooltip: "Access to our API for custom integrations" },
        {text: "Beta Access to New Features", included: true, tooltip: "Get early access to new features and tools"},
      ],
